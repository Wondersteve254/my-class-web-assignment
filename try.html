    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="page/register_students.php" class="nav-link">
        ...
        <div class="row">
          <div class="col-lg-4 col-8">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="#" class="small-box-footer">Industrial<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-4 col-8">
           ...
           <h3><?php echo $count_supervisor; ?></h3>
              ...
              <a href="#" class="small-box-footer">Instituition <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-8">
